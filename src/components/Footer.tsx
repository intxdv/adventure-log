  ...
  return (
    <footer id="footer" className="footer-section" aria-labelledby="colophon-heading">
      ...
      >
        ...
        <div className="footer-landscape-wordmark" aria-label="SLVGNT">
          <svg
          ...
          >
            <defs>
              <filter id="slvgnt-drop-shadow" x="0" y="0" width="2427.76" height="477.35" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
            ...
            <g filter="url(#slvgnt-drop-shadow)">
              <path
                id="slvgnt-char-s"
